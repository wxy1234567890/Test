...
var Add = React.createClass({
	getInitialState: function() {
		return {
			...
			loginname:this.props.option.loginname
		};
	},
	componentDidMount() {
	...
	userPwdEdit: function() {
		...
		this.state.userPwdEdit.userPwdEditDoing({
			...
			param:{
				...
				oldPwd:hex_md5(this.state.loginname.trim() + this.state.oldPwd.trim()),
				newPwd:hex_md5(this.state.loginname.trim() + this.state.newPwd.trim())
			}
		});
	},
