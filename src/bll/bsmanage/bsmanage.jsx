...
var BusinessDetail = React.createClass({
    render: function () {
        ...
        var typeProduct = ["接口产品","智呼产品"]
        var typeName = ["预付费", "后付费","无限制"];
        var typeCharge = ["包月套餐", "包条套餐", "按次计费"];
        return (
            <ul className="basicinfo winfor">
                ...
                <li className="clearfix wbor-h">
                    ...
                    <span className='info-h f10 fr'>{typeProduct[businessInfo.get("type")]}</span>
                </li>
                <li className="clearfix wbor-h">
                ...
                <li className="clearfix wbor-h">
                    ...
                    <span
                        className='info-h f10 fr'>{businessInfo.get("use_limit") < 0 ? "无限制" : businessInfo.get("use_limit")+"次"}</span>
                </li>
                <li className="clearfix wbor-h">
                    <span className='name-h f12 fl'>用户限制</span>
                    <span className='info-h f10 fr'>{typeName[businessInfo.get('user_restrict')]}</span>
                </li>
                <li className="clearfix wbor-h">
                ...
                <li className="clearfix wbor-h">
                    ...
                    <span className='info-h f10 fr'>{businessInfo.get("out_bundle_use") == 0 ? "不允许" : "允许"}</span>
                </li>
                <li className="clearfix wbor-h">
                                ...
                                {this.state.configList.map(function (item, index) {
                                    return (
                                        <tr key={index}>
                                            ...
                                            <td width="30%">
                                                <span className="ellipsis">{item.get("price")+"元/次"}</span>
                                            </td>
                                            <td width="30%">
                                                <span
                ...
                <div className={rightcon2}>
                    ...
                    <div className="mt-25">
                        ...
                        <ul className="tabselect mt-15 pos-rel">
                            ...
                            <li className={this.state.clickcur == 2 ? "selected cur hide" : "selected hide"}
