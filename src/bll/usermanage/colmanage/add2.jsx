...
var colAdd = require('collection/colAdd2');
var menuCodeValid = require('collection/menuCodeValid');
var Add = React.createClass({
	getInitialState:function(){
		return{
			...
			name:"",
			addItem:new colAdd(),
			menuCodeValid:new menuCodeValid()
		};
	},
	...
	okHandler: function() {
		...
		this.state.menuCodeValid.fetch({
			loadingFlag:true,
			param:{
		...
		this.state.menuCodeValid.on("fetchDone",function(){
			this.props.close();
			...
			<div className="diagleft wdiagleft">
				<div className="search-area ml-20 mr-20 mb-10 clearfix">
					...
					<div className="search-box pos-relative fl wsearchbox  wsea ">
						<input placeholder="输入Code" className="s-text" type="text" value={this.state.code} onChange={this.codeChange}/>
