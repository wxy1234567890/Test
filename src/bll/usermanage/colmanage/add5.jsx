...
var colAdd = require('collection/deleteLine');
var Add = React.createClass({
	...
	okHandler: function() {
		...
		this.state.addItem.fetch({
			loadingFlag:true,
			param:{
				productId:this.props.option.param.id,
				id:this.props.option.param.menuId
			}
		});
	},
	//显示或隐藏下拉多选框
		...
		return (
			<div className="dialog-confirm addyw">
				...
				<div className="search-area ml-20 mr-20 mb-10 clearfix">
					<span className="name w85 ">删除当前产品<span className="tip">*</span></span>
				</div>
				</div>
